...
|
|
| You can override constants on this file from your config.php (Location on the root of the script where appllication folder )
|
|
|
| -------------------- DO NOT EDIT THIS FILE -------------------*/
...
| App version
*/
defined('APP_VERSION') OR define('APP_VERSION', '2.7.5');
defined('APP_VERSION_DEV') OR define('APP_VERSION_DEV', '275');
/*
| Assets version
*/
defined('ASSETS_VERSION') OR define('ASSETS_VERSION', 'kp'.APP_VERSION_DEV);
/*
...
defined('PROXYTYPE') OR define('PROXYTYPE', 0);
/*
| Enable image auto resize
*/
defined('AUTO_RESIZE') OR define('AUTO_RESIZE', TRUE);
defined('ENABLE_WATERMARK') OR define('ENABLE_WATERMARK', FALSE);
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
|
*/
defined('ENABLE_IN_PROGRESS_SCHEDULE') OR define('ENABLE_IN_PROGRESS_SCHEDULE', TRUE);
defined('URI_PROTOCOL') OR define('URI_PROTOCOL', "REQUEST_URI");
/*
|--------------------------------------------------------------------------
...
defined("FORCE_DOWNGRADE_FB_ACCOUNTS") oR define("FORCE_DOWNGRADE_FB_ACCOUNTS", FALSE);

defined('SITE_SIGNATURE') OR define("SITE_SIGNATURE", FALSE);
defined('SCHEDULE_DEFAULT_VIEW') OR define("SCHEDULE_DEFAULT_VIEW", "table");
...
defined('MODULES_FOLDER_NAME') OR define('MODULES_FOLDER_NAME', "modules");
...
defined('ENABLE_PAYZA') OR define('ENABLE_PAYZA', FALSE);
defined('ENABLE_STPAY') OR define('ENABLE_STPAY', FALSE);
/*
| Email from header
*/
...
| Load nodes via ajax
*/
defined('LOAD_NODES_AJAX') OR define('LOAD_NODES_AJAX', FALSE);
/*
|--------------------------------------------------------------------------
